                ...
                <?php if ($_GET['respuesta'] == "correcto"){ ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php if ($_GET['action'] == "create"){ ?>
                            Persona ha sido creada con exito!
                        <?php }else if($_GET['action'] == "update"){ ?>
                            Los datos de Persona han sido actualizados correctamente!
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
                            ...
                            <table id="tblPersona" class="datatable table table-bordered table-striped">
                                ...
                                foreach ($arrPersona as $Persona){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $Persona->getNDocumento(); ?></td>
                                        <td><?php echo $Persona->getTelefonoFijo(); ?></td>
                                        <td><?php echo $Persona->getNCelular(); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($Persona->getEstado() != "Activo"){ ?>
                                                <a href="../../../App/Controladores/PersonaControlador.php?action=activate&Id=<?php echo $Persona->getId(); ?>" type="button" data-toggle="tooltip" title="Activar" class="btn docs-tooltip btn-success btn-xs"><i class="fa fa-check-square"></i></a>
                                            <?php }else{ ?>
                                                <a type="button" href="../../../App/Controladores/PersonaControlador.php?action=inactivate&Id=<?php echo $Persona->getId(); ?>" data-toggle="tooltip" title="Inactivar" class="btn docs-tooltip btn-danger btn-xs"><i class="fa fa-times-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
