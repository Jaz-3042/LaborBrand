...
if(!empty($_GET['action'])){
    ProveedorControlador::main($_GET['action']);
}else{
...
class ProveedorControlador
{
    ...
    static public function create()
    {
        try {
            ...
            $arrayProveedor['Representante_Legal'] = $_POST['Representante_Legal'];
            if(!Proveedor::proveedorRegistrado($arrayProveedor['Nombre'])){
                $Proveedor = new Proveedor ($arrayProveedor);
                $Proveedor->create();
                header("Location: ../../Vistas/modules/proveedor/index.php?respuesta=correcto&action=create");
            }else{
                header("Location: ../../Vistas/modules/proveedor/create.php?respuesta=error&mensaje=Departamento ya registrado");
            }
        } catch (Exception $e) {
            header("Location: ../../Vistas/modules/proveedor/create.php?respuesta=error&mensaje=" . $e->getMessage());
        }
    }
