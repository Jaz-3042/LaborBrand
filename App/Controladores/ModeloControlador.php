...
if(!empty($_GET['action'])){
    ModeloControlador::main($_GET['action']);
}else{
...
class ModeloControlador
{
    ...
    {
        if ($action == "create") {
            ModeloControlador::create();
        }/* else if ($action == "editar") {
            ModeloControlador::editar();
        } else if ($action == "buscarID") {
           ModeloControlador::buscarID($_REQUEST['Nombre']);
        } else if ($action == "ActivarNombre") {
            ModeloControlador::ActivarNombre();
        } else if ($action == "InactivarMarca_Id") {
            ModeloControlador::InactivarMarca_Id();
        }else if ($action == "login"){
           ModeloControlador::login();
        }else if($action == "cerrarSession"){
            ModeloControlador::cerrarSession();
        }*/
    ...
    static public function create()
    {
        try {
            $arrayModelo = array();
            $arrayModelo['Nombre'] = $_POST['Nombre'];
            $arrayModelo['Marca_Id'] = $_POST['Marca_Id'];

            if (!Modelo::ModeloRegistrado($arrayModelo['Nombre'])) {
                $Modelo = new Modelo ($arrayModelo);
                $Modelo->create();
                header("Location: ../../Vistas/modules/Modelo/index.php?respuesta=correcto&action=create");
            } else {
                header("Location: ../../Vistas/modules/Modelo/create.php?respuesta=error&mensaje=Modelo ya registrado");
            }
        } catch (Exception $e) {
            header("Location: ../../Vistas/modules/Modelo/create.php?respuesta=error&mensaje=" . $e->getMessage());
        }
