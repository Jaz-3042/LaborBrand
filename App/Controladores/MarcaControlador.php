...
if(!empty($_GET['action'])){
    MarcaControlador::main($_GET['action']);
}else{
...
class MarcaControlador
{
    ...
    {
        if ($action == "create") {
            MarcaControlador::create();
        }/* else if ($action == "editar") {
            MarcaControlador::editar();
        } else if ($action == "buscarID") {
            MarcaControlador::buscarID($_REQUEST['id']);
        } else if ($action == "ActivarNombre") {
          MarcaControlador::ActivarNombre();
        } else if ($action == "InactivarMarca") {
          MarcaControlador::InactivarNombre();
        }else if ($action == "login"){
           MarcaControlador::login();
        }else if($action == "cerrarSession"){
            MarcaControladorr::cerrarSession();
        }*/
      ...
      static public function create()
    {
        try {
            ...
            if(!Marca::MarcaRegistrado($arrayMarca['Nombre'])){
                ...
                $Marca->create();
                header("Location: ../../Vistas/modules/Marca/index.php?respuesta=correcto&action=create");
            }else{
                header("Location: ../../Vistas/modules/Marca/create.php?respuesta=error&mensaje=Marca ya registrado");
            }
        } catch (Exception $e) {
            header("Location: ../../Vistas/modules/Marca/create.php?respuesta=error&mensaje=" . $e->getMessage());
        }
    }
